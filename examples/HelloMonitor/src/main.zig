...
const Star = struct {
    ...
    fn move(self: *Star) void {
        if (s_surface) |surface| {
            var rect = zguilite.Rect.init2(@intFromFloat(self.x), @intFromFloat(self.y), @intFromFloat(self.size), @intFromFloat(self.size));
            surface.fill_rect(
                rect,
                0,
                Z_ORDER_LEVEL_0,
            ...
            rect = zguilite.Rect.init2(@intFromFloat(self.x), @intFromFloat(self.y), @intFromFloat(self.size), @intFromFloat(self.size));
            surface.fill_rect(
                rect,
                GL_RGB(255, 255, 255),
                Z_ORDER_LEVEL_0,
