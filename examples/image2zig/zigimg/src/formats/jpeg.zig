...
pub const JPEG = struct {
    frame: ?Frame = null,
    allocator: Allocator,
    quantization_tables: [4]?QuantizationTable = std.mem.zeroes([4]?QuantizationTable),
    dc_huffman_tables: [4]?HuffmanTable = std.mem.zeroes([4]?HuffmanTable),
    ac_huffman_tables: [4]?HuffmanTable = std.mem.zeroes([4]?HuffmanTable),
