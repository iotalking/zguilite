...
fn filterChoiceHeuristic(scanline: color.PixelStorage, previous_scanline: ?color.PixelStorage) FilterType {
    ...
    var previous_bytes: [filter_types.len]u8 = std.mem.zeroes([filter_types.len]u8);
    var combos: [filter_types.len]usize = std.mem.zeroes([filter_types.len]usize);
    var scores: [filter_types.len]usize = std.mem.zeroes([filter_types.len]usize);
